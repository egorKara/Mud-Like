...
namespace MudLike.Core.Performance
{
    ...
    public partial class ComputeShaderAcceleratorSystem : SystemBase
    {
        ...
        private void ProcessVehiclePhysicsOnGPU()
        {
            ...
            _vehiclePhysicsCompute.SetFloat("DeltaTime", Time.fixedDeltaTime);
        ...
        private void ProcessWheelPhysicsOnGPU()
        {
            ...
            _wheelPhysicsCompute.SetFloat("DeltaTime", Time.fixedDeltaTime);
        ...
        private void ProcessTerrainOnGPU()
        {
            ...
            _terrainCompute.SetFloat("DeltaTime", Time.fixedDeltaTime);
        ...
        private void UploadVehicleDataToGPU()
        {
            ...
            for (int i = 0; i < vehiclePhysicsArray.Length && i < BUFFER_SIZE; i++)
            {
                ...
                gpuData[baseIndex + 6] = vehiclePhysicsArray[i].Acceleration.x;
                gpuData[baseIndex + 7] = vehiclePhysicsArray[i].Acceleration.y;
                gpuData[baseIndex + 8] = vehiclePhysicsArray[i].Acceleration.z;
        ...
        {
            var wheelDataArray = _wheelQuery.ToComponentDataArray<WheelData>(Allocator.Temp);
        ...
        {
            var terrainDataArray = _terrainQuery.ToComponentDataArray<TerrainData>(Allocator.Temp);
        ...
        private void DownloadVehicleDataFromGPU()
        {
            ...
            _resultBuffer.GetData(resultData);
