...
namespace MudLike.Core.Constants
{
    ...
    public static class SystemConstants
    {
        ...
        // Константы для транспортных средств (MudRunner-like)
        public const float VEHICLE_DEFAULT_MASS = 2000.0f;
        public const float VEHICLE_DEFAULT_MAX_SPEED = 50.0f;
        public const float VEHICLE_DEFAULT_ACCELERATION = 10.0f;
        public const float VEHICLE_DEFAULT_BRAKE_FORCE = 5000.0f;
        public const float VEHICLE_DEFAULT_STEER_ANGLE = 30.0f;
        public const float VEHICLE_DEFAULT_WHEEL_RADIUS = 0.5f;
        public const float VEHICLE_DEFAULT_WHEEL_WIDTH = 0.3f;
        public const float VEHICLE_DEFAULT_SUSPENSION_DISTANCE = 0.3f;
        public const float VEHICLE_DEFAULT_SUSPENSION_FORCE = 35000.0f;
        public const float VEHICLE_DEFAULT_SUSPENSION_DAMPER = 4500.0f;
        public const float VEHICLE_DEFAULT_SUSPENSION_TARGET = 0.5f;
        
        // Константы для деформации террейна
        public const float TERRAIN_DEFAULT_HARDNESS = 1.0f;
        public const float TERRAIN_DEFAULT_DEFORMATION_RATE = 0.1f;
        public const float TERRAIN_DEFAULT_RECOVERY_RATE = 0.05f;
        public const float TERRAIN_DEFAULT_MAX_DEPTH = 0.5f;
        public const float TERRAIN_DEFAULT_MIN_DEPTH = -0.2f;
        public const int TERRAIN_DEFAULT_RESOLUTION = 513;
        public const float TERRAIN_DEFAULT_SIZE = 1000.0f;
        
        // Константы для мультиплеера
        public const float NETWORK_DEFAULT_SEND_RATE = 20.0f;
        public const float NETWORK_DEFAULT_SNAPSHOT_RATE = 60.0f;
        public const int NETWORK_DEFAULT_BUFFER_SIZE = 1024;
        public const float NETWORK_DEFAULT_LAG_COMPENSATION = 0.1f;
        
        // Константы для детерминизма
        public const float DETERMINISTIC_EPSILON = 0.0001f;
        public const int DETERMINISTIC_MAX_ITERATIONS = 100;
        public const float DETERMINISTIC_CONVERGENCE_THRESHOLD = 0.001f;
    }
}
