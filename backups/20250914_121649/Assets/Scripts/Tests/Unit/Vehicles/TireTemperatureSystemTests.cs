...
{
    /// <summary>
    /// Тесты для системы температуры шин TireTemperatureSystem
    /// </summary>
    public class TireTemperatureSystemTests
    {
        private World _world;
        private TireTemperatureSystem _tireTemperatureSystem;
        ...
        public void SetUp()
        {
            ...
            _tireTemperatureSystem = _world.GetOrCreateSystemManaged<TireTemperatureSystem>();
            _tireTemperatureSystem.OnCreate(ref _world.Unmanaged);
        ...
        {
            _tireTemperatureSystem.OnDestroy(ref _world.Unmanaged);
            _world.Dispose();
        }

        [Test]
        public void TireTemperatureSystem_OnCreate_InitializesCorrectly()
        {
            Assert.IsNotNull(_tireTemperatureSystem);
        }

        [Test]
        public void TireTemperatureSystem_OnUpdate_ProcessesWithoutErrors()
        {
            _tireTemperatureSystem.OnUpdate(ref _world.Unmanaged);
            Assert.IsNotNull(_tireTemperatureSystem);
        }

        [Test]
        public void TireTemperatureSystem_WithTireData_ProcessesCorrectly()
        {
        ...
        [Test]
        public void TireTemperatureSystem_WithWeatherData_ProcessesCorrectly()
        {
            var entity = _entityManager.CreateEntity();
            _entityManager.AddComponentData(entity, new TireData
            {
        ...
        [Test]
        public void TireTemperatureSystem_HighTemperature_ProcessesCorrectly()
        {
            var entity = _entityManager.CreateEntity();
            _entityManager.AddComponentData(entity, new TireData
            {
        ...
        [Test]
        public void TireTemperatureSystem_MultipleTires_HandlesCorrectly()
        {
            for (int i = 0; i < 6; i++)
            {
                var entity = _entityManager.CreateEntity();
        ...
        [Test]
        public void TireTemperatureSystem_EdgeCases_HandleCorrectly()
        {
            var entity = _entityManager.CreateEntity();
            _entityManager.AddComponentData(entity, new TireData
            {
