# 🔄 Mud-Like ECS Migration Guide

## 🎯 **ОБЗОР МИГРАЦИИ**

### **Цель миграции**
Переход от гибридной архитектуры MonoBehaviour/ECS к чистой ECS-архитектуре для обеспечения детерминизма и производительности мультиплеера.

### **Принципы миграции**
- **Итерационный подход** - постепенная миграция модулей
